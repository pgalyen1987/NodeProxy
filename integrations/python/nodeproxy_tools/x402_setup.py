...
def build_x402_session(
    *,
    ...
    """Return (client, requests session) with registered payment schemes."""
    ...
    try:
        ...
        raise ImportError('Install x402 extras: pip install "package[x402]"') from exc
    ...
    if sol_key:
        try:
            ...
            raise ImportError(
                'Solana payments require: pip install "package[x402]" with x402[svm] (solders).'
            ) from exc
